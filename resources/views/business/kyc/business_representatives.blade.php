            ...
            <div class="page-ath-form center-div">
                <div class="progress-container">
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        <a href="{{ route('business.kyc.apply') }}?current=3"><div class="btn-back mb-4"><i class="fas fa-angle-left"></i> &nbsp;Previous Step</div></a>
                    ...
                    <form id="formValidate" method="post" action="">
                        ...
                        <div class="center-button">
                            <a href="{{ route('business.kyc.apply') }}?current=5" class="skip">Skip to Business Documents
