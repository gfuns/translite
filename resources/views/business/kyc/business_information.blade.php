            ...
            <div class="page-ath-form center-div">
                <div class="progress-container">
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        <a href="{{ route('business.kyc.apply') }}?current=2"><div class="btn-back mb-4"><i class="fas fa-angle-left"></i> &nbsp;Previous Step</div></a>
                    ...
                    <div class="stepDisplay">Step 3 of 8</div>
                    <div class="processHeading">Enter Business Information</div>
                    <p class="processDescription mb-5">Enter your business information so we can verify your account and
                        deposit
                        you earnings.</p>
                    <form id="formValidate" method="post" action="">
                        ...
                        <div class="center-button">
                            <a href="{{ route('business.kyc.apply') }}?current=4" class="skip">Skip to Business
                                Representatives <i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    </form>
