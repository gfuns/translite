                                        ...
                                        <div class="d-flex flex-column flex-md-row" style="gap: 15px;">
                                            <div class="pmbox">
                                                <div style="display: flex; gap: 10px;">
                                                   <div> <canvas id="card" style="width:50px; height: 5px;"></canvas></div>
                                                    <div>Card<br /><span>3</span></div>
                                                </div>
                                            </div>
                                            <div class="pmbox">
                                                <div style="display: flex; gap: 10px;">
                                                   <div> <canvas id="transfer" style="width:50px; height: 5px;"></canvas></div>
                                                    <div>Bank Transfer<br /><span>0</span></div>
                                                </div>
                                            </div>
                                            <div class="pmbox">
                                                <div style="display: flex; gap: 10px;">
                                                   <div> <canvas id="ussd" style="width:50px; height: 5px;"></canvas></div>
