                                ...
                                <div class="col-12 col-md-7 nopadding">
                                    <div>
                                        <div class="custombox" style="display: flex; gap: 10px">
                                            <a href="{{ route('business.settings.settlement') }}" class="tabactive">
                                                <div class="tabtext">Default Settlement Configuration</div>
                                            </a>
                                            <a href="{{ route('business.settings.dynamicSettlement') }}"
                                                class="tabinactive">
                                                <div class="tabtext">Dynamic Settlement Configuration</div>
                                            </a>
                                            <a href="{{ route('business.settings.settlementAccounts') }}"
                                                class="tabinactive">
