                    ...
                    <div class="element-wrapper">
                        ...
                        <div class="element-content">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <a class="element-box el-tablo" href="#" style="padding:30px">
                                        <div class="label" style="color:black; font-size: 12px"><strong>Settled</strong></div>
                                ...
                                <div class="col-6 col-md-3">
                                    <a class="element-box el-tablo" href="#" style="padding:30px">
                                        <div class="label" style="color:black; font-size: 12px"><strong>Pending</strong></div>
                                ...
                                <div class="col-6 col-md-3">
                                    <a class="element-box el-tablo" href="#" style="padding:30px">
                                        <div class="label" style="color:black; font-size: 12px"><strong>Queued</strong></div>
