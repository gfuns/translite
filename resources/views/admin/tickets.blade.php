                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Customer Support Tickets</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="example" class="table mb-0 text-nowrap table-hover table-centered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="thh">Issue</td>
                                            <td class="thh">Description</td>
                                    ...
                                    <tbody>
                                        @foreach ($tickets as $at)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td style="white-space: break-word">{{ $at->business->businessName }}</td>
                                                <td style="white-space: pre-wrap">{{ $at->issue }}</td>
                                                <td style="white-space: pre-wrap">{{ $at->description }}</td>
                                                <td>
                                                    @if ($at->status == 'closed')
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" style="">
                                                            <li>
                                                                <a class="dropdown-item mb-2" href="#"
                                                                    ...
                                                                    Details</a>
                                                                @if (app('Menu')->canEdit(Auth::user()->role_id, 10) == true)
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td class=""><strong>Issue:</strong></td>
        ...
        <div class="modal fade" id="closeDispute" tabindex="-1" role="dialog" aria-labelledby="newCatgoryLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('admin.closeTicket') }}">
                        <div class="modal-body">
                            @csrf
                            <div class="row">
                                <!-- form group -->
                                ...
                                <input id="myid" type="hidden" name="ticket_id" class="form-control" required>
                            </div>
                        </div>
                        <div class="modal-footer">
