...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Transfer Fee Configuration</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table mb-0 text-nowrap table-hover table-centered">
                                    ...
                                    <tbody>
                                        @foreach ($transferSettings as $at)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td>{{ ucwords($at->category) }} Transfers</td>
                                                <td>{{ $at->narration }}</td>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" style="">
                                                            <li>
                                                                <a class="dropdown-item mb-2" href="#"
                                                                    ...
                                                                    data-transtype="{{ ucwords($at->category) }} Transfers"
                ...
                <form method="post" action="{{ route('admin.updateFeeAmount') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            <label class="form-label"><strong>Transaction Type </strong><span
                                    class="text-danger">*</span></label>
                            <input id="transType" type="text" name="transaction_type" class="form-control"
                                placeholder="Transaction Type" required readonly>
                        </div>
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input id="feeAmount" type="text" name="fee_amount" class="form-control"
    ...
    <script type="text/javascript">
        ...
        document.getElementById("trfee").classList.add('active');
    </script>
@endsection
