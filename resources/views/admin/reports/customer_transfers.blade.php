                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Customer Transfers</div>
                        </div>

                        <div class="card-body">
                            <div class="col-md-12">
                                <form method="POST" action="{{ route('report.searchTransfers') }}">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="hidden" name="type" value="{{ $defType }}" />
                            ...
                            <h6 class="mt-4 mb-4 ms-4"><strong>
                                    ...
                                    {{ ucwords(isset($type) ? $type . ' Customer Transfer Transactions' : 'Customer Transfer Transactions') }}
                                ...
                                <table class="table mb-0 text-nowrap table-hover table-centered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="th">Sender Details</td>
                                            <td class="th">Receiver Details</td>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($transfers as $trx)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td>{{ $trx->reference }}</td>
                                                <td>{{ $trx->sender_name }}<br/>{{ $trx->sender_bank }}<br/>{{ $trx->sender_account }}</td>
                                                <td>{{ $trx->receiver_name }}<br/>{{ $trx->receiver_bank }}<br/>{{ $trx->receiver_account }}</td>
