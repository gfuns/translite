                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Registered Businesses</h4>
                    ...
                    <form method="post" action="{{ route('admin.storeBusiness') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <select id="customer" name="user_id" class="form-select" data-width="100%" required>
                                    <option value="">Select Customer</option>
                                    @foreach ($customers as $cust)
                                        <option value="{{ $cust->id }}">
                                            {{ $cust->lastName . ', ' . $cust->firstName . ' ' . $cust->otherNames }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
