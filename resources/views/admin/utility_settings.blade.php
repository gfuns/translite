...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Utility Transaction Fee Configuration</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table mb-0 text-nowrap table-hover table-centered">
                                    ...
                                    <tbody>
                                        @foreach ($utilitySettings as $at)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td>{{ ucwords($at->category) }} Purchase</td>
                                                <td>{{ $at->narration }}</td>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" style="">
                                                            <li>
                                                                <a class="dropdown-item mb-2" href="#"
                                                                    ...
                                                                    data-transtype="{{ ucwords($at->category) }} Purchase"
    ...
    <script type="text/javascript">
        ...
        document.getElementById("utfee").classList.add('active');
    </script>
@endsection
